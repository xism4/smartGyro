...
public class AlertDialogLayout extends C0357Q {
    ...
    /* renamed from: b */
    private void m1438b(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m1439c(View view) {
        int e = C0127u.m451e(view);
        if (e > 0) {
            return e;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1439c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: e */
    private void m1440e(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0357Q.C0358a aVar = (C0357Q.C0358a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: f */
    private boolean m1441f(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0141f.topPanel) {
                    view = childAt;
                } else if (id == C0141f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0141f.contentPanel && id != C0141f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            android.support.v7.widget.Q$a r15 = (android.support.p025v7.widget.C0357Q.C0358a) r15
            int r2 = r15.f1302b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = p000a.p001a.p005c.p014g.C0127u.m450d(r17)
            int r2 = p000a.p001a.p005c.p014g.C0111f.m395a(r2, r3)
            r2 = r2 & 7
            r3 = 1
        ...
        L_0x00bd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p025v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
