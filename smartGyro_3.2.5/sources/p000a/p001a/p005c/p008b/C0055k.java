...
/* renamed from: a.a.c.b.k */
public class C0055k {
    /* renamed from: a */
    public static File m208a(Context context) {
    ...
    /* renamed from: a */
    public static ByteBuffer m209a(Context context, Resources resources, int i) {
        File a = m208a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m213a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m211a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    public static java.nio.ByteBuffer m210a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        /*
        ...
        L_0x0067:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p001a.p005c.p008b.C0055k.m210a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.nio.ByteBuffer m211a(java.io.File r9) {
        /*
            r0 = 0
        ...
        L_0x0032:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p001a.p005c.p008b.C0055k.m211a(java.io.File):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static void m212a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
    ...
    /* renamed from: a */
    public static boolean m213a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m214a(file, inputStream);
                m212a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m212a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static boolean m214a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m212a((Closeable) fileOutputStream2);
                ...
                try {
                    ...
                    m212a((Closeable) fileOutputStream);
                    StrictMode.setThreadPolicy(allowThreadDiskWrites);
                    return false;
                } catch (Throwable th) {
                    th = th;
