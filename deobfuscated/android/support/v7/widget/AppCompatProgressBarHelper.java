...
class AppCompatProgressBarHelper
{
  ...
  private android.graphics.drawable.Drawable tileify(android.graphics.drawable.Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (android.support.v4.graphics.drawable.Drawable)paramDrawable;
      localObject2 = ((android.support.v4.graphics.drawable.Drawable)localObject1).getWrappedDrawable();
      if (localObject2 != null)
      {
        ((android.support.v4.graphics.drawable.Drawable)localObject1).setWrappedDrawable(tileify((android.graphics.drawable.Drawable)localObject2, paramBoolean));
    ...
    else
    {
      if ((paramDrawable instanceof LayerDrawable))
      {
        ...
        localObject1 = new android.graphics.drawable.Drawable[k];
        int j = 0;
        int i = 0;
        while (i < k)
        {
