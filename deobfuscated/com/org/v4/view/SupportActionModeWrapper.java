  ...
  extends android.view.ActionMode
{
  ...
  {
    final ArrayList<f> mActionModes;
    final i<Menu, Menu> mMenus;
    ...
    private Menu getMenuWrapper(Menu paramMenu)
    {
      ...
      if (localMenu2 == null)
      {
        localMenu1 = MenuWrapperFactory.wrapSupportMenu(SupportActionModeWrapper.this, (SupportMenu)paramMenu);
    ...
    {
      return mWrappedCallback.onActionItemClicked(getActionModeWrapper(paramActionMode), MenuWrapperFactory.wrapSupportMenuItem(SupportActionModeWrapper.this, (SupportMenuItem)paramMenuItem));
    }
