  ...
  public class PathDataNode
  {
    ...
    private static void arcToBezier(Path paramPath, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8, double paramDouble9)
    {
      ...
      for (;;)
      {
        ...
        paramDouble9 = paramDouble1 + d1 * d5 * d12 - d8 * d4;
        double d3 = paramDouble2 + d1 * d6 * d12 + d10 * d4;
        d1 = d7 * d4 - d8 * d12;
        d4 = d4 * d9 + d12 * d10;
        ...
        paramPath.cubicTo((float)(paramDouble4 + paramDouble6 * paramDouble8), (float)(paramDouble7 + paramDouble5 * paramDouble8), (float)(paramDouble9 - paramDouble8 * d1), (float)(d3 - paramDouble8 * d4), (float)paramDouble9, (float)d3);
        i += 1;
        paramDouble7 = d3;
        paramDouble8 = d2;
        paramDouble5 = d4;
