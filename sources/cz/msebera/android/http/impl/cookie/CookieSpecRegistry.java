...
@Deprecated
public class CookieSpecRegistry implements CookieSpecFactory, CookieSpecProvider {
    ...
    public CookieSpecRegistry(String[] strArr, boolean z) {
    ...
    public cz.msebera.android.http.cookie.CookieSpec newInstance(cz.msebera.android.http.util.HttpParams r12) {
        ...
        L_0x001d:
            ...
            cz.msebera.android.http.impl.cookie.RFC2109Spec r10 = new cz.msebera.android.http.impl.cookie.RFC2109Spec
            r10.<init>((java.lang.String[]) r0, (boolean) r8)
            return r10
        L_0x002a:
            cz.msebera.android.http.impl.cookie.RFC2109Spec r10 = new cz.msebera.android.http.impl.cookie.RFC2109Spec
            r10.<init>()
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: cz.msebera.android.http.impl.cookie.CookieSpecRegistry.newInstance(cz.msebera.android.http.util.HttpParams):cz.msebera.android.http.cookie.CookieSpec");
    }
}
